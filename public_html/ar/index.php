            ...
            if (source instanceof HTMLImageElement || (source instanceof HTMLVideoElement && source.readyState === source.HAVE_ENOUGH_DATA)) {
                ...
                for (i = 0; i < markerCount; i++) {
                    ...
                    if (typeof markers[currId] === 'undefined') {
                        ...
                        var url = purl();
                        var sha = url.param('sha');
                        // sha = '851d41421cb53636123b5dfc0fcb198c54ab3e8f'; // for debugging
                        ...
                        // for one image
                        // var material = new THREE.MeshBasicMaterial( {
                        //     map:THREE.ImageUtils.loadTexture('res/test.png')
                        // });

                        // Add the marker models and suchlike into your marker root object.
                        // height = 89; // for debugging
                        // width = 59; // for debugging
                        // depth = 29.5; // for debugging
                        height_mm = height * 10;
                        width_mm = width * 10;
                        depth_mm = depth * 10;
